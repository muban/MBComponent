...
public class PathLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private PathLayoutManager.OnItemSelectedListener mItemSelectedListener;
...
//            mItemOffset改变后要刷新mItemCountInScreen
     ...
     * 设置Item选中后的监听器
     */
    public void setOnItemSelectedListener(PathLayoutManager.OnItemSelectedListener listener) {
